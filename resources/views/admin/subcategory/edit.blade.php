...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('upadate-subcategory/' . $subcategory->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-2">
                                <button type="submit" class="btn btn-primary mt-2" name="update_subcategory_btn">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
