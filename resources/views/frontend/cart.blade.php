                ...
                @if ($cartitems->count() > 0)
                                <div class="col-lg-12">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($cartitems as $item)
                                                                        ...
                                                                        <tr class="product_data">
                                                                                ...
                                                                                {{-- <form> --}}
                                                                                    ...
                                                                                    @if($item->products->qty > 0)
                                                                                        <div class="quantity buttons_added">
                                                                                            ...
                                                                                            <input type="button" value="-" class="minus changeqty decrement-btn">
                                                                                            <input type="number" step="1" min="1" max="{{ $item->products->qty }}"
                                                                                                name="quantity" class="input-qty" value="{{ $item->prod_qty }}"
                                                                                                disabled>
                                                                                            <input type="button" value="+" class="plus changeqty increment-btn">
                                                                                        </div>
                                                                                    @else
                                                                                        Out Of Stock
                                                                                    @endif
                                                                            ...
                                                                            {{-- <td>${{ number_format((float) $item->products->selling_price * (int)
                                                                                $item->prod_qty, 2) }}
                                                                            </td> --}}
                                                                        ...
                                                                        @if($item->products->qty > 0)
                                                                                                @php
                                                                                                $total += (float) $item->products->selling_price * (int) $item->prod_qty; @endphp
                                                                        @endif
                                                @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="table-btn mt-4">
                                        ...
                                        <!-- <button type="button" class="btn btn-primary changeqty">Update Cart</button> -->
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-5">
