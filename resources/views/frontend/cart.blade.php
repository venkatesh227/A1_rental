        ...
        <div class="container">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($cartitems as $item)
                                                    ...
                                                    @if ($item->products->qty > 0)
                                                        <div class="quantity buttons_added">
                                                            ...
                                                            <input type="number" step="1" min="1"
                                                                max="{{ $item->products->qty }}" name="quantity"
                                                                class="input-qty" value="{{ $item->prod_qty }}" disabled>
                                            ...
                                            @if ($item->products->qty > 0)
                                                @php
                                                    $total +=
                                                        (float) $item->products->selling_price * (int) $item->prod_qty;
                                                @endphp
                                            @endif
                                        @endforeach
                                    </tbody>
            ...
            @else
                <div class="card-body text-center">
                    ...
                    <a href="{{ url('view-products') }}" class="btn btn-outline-primary float-end">Continue
                        Shopping</a>
                </div>
                @endif
